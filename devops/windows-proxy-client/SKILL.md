---
name: windows-proxy-client
description: 在 Windows 机器上部署/维护代理客户端（sing-box / Xray），含带宽测试工具。通过 SSH 部署纯 CLI 代理——下载二进制、远程配置、持久化运行、版本兼容性。v2rayN 仅作 GUI 壳，实际跑 Xray 核心。
---
