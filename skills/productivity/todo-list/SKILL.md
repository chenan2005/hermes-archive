...
- s8 [2026-07-06] Memex 个人知识助手方案设计 | session:20260706_201822_0dfb10 | 暂无持久文件（方案讨论中） | 定名 Memex。从资料收集起步（头条/B站/飞书/PDF），四层架构：采集→标准化→智能→存储。交互以被动查询为主，四种主动推送（定时摘要/异常告警/知识缺口/关联发现）。待决定第一期 MVP 和技术选型。
