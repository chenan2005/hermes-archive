---
name: openclash-debug
title: OpenClash Debug
description: 调试 OpenClash 代理连通性问题的排查流程, covering musl compatibility, init script pitfalls, config migration from PassWall, VHDX disk expansion, DNS respect-rules/proxy-server-nameserver config, mihomo alpha memory leak & OOM diagnosis, and core upgrade/rollback.
---
